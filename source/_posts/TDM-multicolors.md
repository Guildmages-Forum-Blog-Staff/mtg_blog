...
- [龍魂杳渺骨凝雪：韃契可汗的故事](https://dominarialibrary.com/story-of-khans-of-tarkir/)
...
| **預兆 — 風暴龍裔（U）** | {% mtglink "Purging Stormbrood" %} | {% mtglink "Runescale Stormbrood" %} | {% mtglink "Disruptive Stormbrood" %} | {% mtglink "Twinmaw Stormbrood" %} | {% mtglink "Whirling Stormbrood" %} | 
...
在三色環境裡打限制賽是相對困難的，不過，好在這次TDM售前現開盒有特殊的設計，讓你在選定主題時基本上就能鎖定一個三色色組。每個售前盒都包括以下內容：
